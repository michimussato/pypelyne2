...
function RRgetPassesInfo(sceneInfo)
{
    ...
    for( p = 1; p <= app.project.renderQueue.numItems; p++ )   {
        ...
        passes.p[passes.max-1].seqFileOffset=(app.project.renderQueue.item( p).comp.displayStartTime/frameDuration);
    ...
    if  (passes.max==1)  {
        ...
        passes.p[0].seqFileOffset= passes.p[1].seqFileOffset;
