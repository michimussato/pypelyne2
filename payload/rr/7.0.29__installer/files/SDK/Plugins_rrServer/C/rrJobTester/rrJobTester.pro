...
mac {
  DEFINES +=  rrConsoleApp rrPlugin defrrJobTester
  QT += 
  QT       -= gui
  ...
  CONFIG(debug, debug|release) {
	...
	LIBS +=  -L../../../../_libs/osx -framework CoreFoundation -framework ApplicationServices -lz
	OBJECTS_DIR = ../../../../z_compiler_files/release_mac_rrJobTester
...
#	QMAKE_LFLAGS += -Wl,-z,origin \'-Wl,-rpath,$${IDE_PLUGIN_RPATH}\',--hash-style=sysv
  ...
  TARGET = lx_rrJobTester$${BIT_DEPTH}
  CONFIG(debug, debug|release) {
  ...
  QT       -= gui
	LIBS +=  -L../../../_libs
	OBJECTS_DIR = ../../../z_compiler_files/debug_lx$${BIT_DEPTH}_rrJobTester
  ...
  QT       -= gui
	...
	LIBS +=  -L../../../_libs
	OBJECTS_DIR = ../../../z_compiler_files/release_lx$${BIT_DEPTH}_rrJobTester
