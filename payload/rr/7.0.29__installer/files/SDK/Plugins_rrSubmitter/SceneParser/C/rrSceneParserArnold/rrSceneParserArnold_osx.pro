...
mac {
  DEFINES +=  QT_XML_LIB rrConsoleApp rrPlugin defrrSceneParserArnold
  QT +=  xml
  QT       -= gui
  ...
  TARGET = mac_rrSceneParserArnold
  CONFIG(debug, debug|release) {
	...
	OBJECTS_DIR = ../../../../z_compiler_files/debug_mac_rrSceneParserArnold
	...
	LIBS +=  -L../../../../_libs/osx -framework CoreFoundation -framework ApplicationServices -lz
	OBJECTS_DIR = ../../../../z_compiler_files/release_mac_rrSceneParserArnold
...
#	QMAKE_LFLAGS += -Wl,-z,origin \'-Wl,-rpath,$${IDE_PLUGIN_RPATH}\',--hash-style=sysv
  ...
  TARGET = lx_rrSceneParserArnold$${BIT_DEPTH}
  CONFIG(debug, debug|release) {
  ...
  QT       -= gui
	LIBS +=  -L../../../_libs
	OBJECTS_DIR = ../../../z_compiler_files/debug_lx$${BIT_DEPTH}_rrSceneParserArnold
  ...
  QT       -= gui
	...
	LIBS +=  -L../../../_libs
	OBJECTS_DIR = ../../../z_compiler_files/release_lx$${BIT_DEPTH}_rrSceneParserArnold
  ...
  TARGET = rrSceneParserArnold$${BIT_DEPTH}
  CONFIG(debug, debug|release) {
	DESTDIR = ../../../_debug/plugins/submitter_sceneparser
	LIBS +=  -L../../../_libs
	OBJECTS_DIR = ../../../z_compiler_files/debug_mac_rrSceneParserArnold
...
# Include file(s)
include(rrSceneParserArnold.pri)
