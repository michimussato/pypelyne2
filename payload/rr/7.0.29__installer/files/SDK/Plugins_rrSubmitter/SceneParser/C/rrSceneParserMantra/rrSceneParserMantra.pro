...
mac {
  DEFINES +=  QT_XML_LIB rrConsoleApp rrPlugin defrrSceneParserMantra
  QT +=  xml
  QT       -= gui
  ...
  TARGET = mac_rrSceneParserMantra
  CONFIG(debug, debug|release) {
	...
	OBJECTS_DIR = ../../../../z_compiler_files/debug_mac_rrSceneParserMantra
	...
	LIBS +=  -L../../../../_libs/osx -framework CoreFoundation -framework ApplicationServices -lz
	OBJECTS_DIR = ../../../../z_compiler_files/release_mac_rrSceneParserMantra
...
#	QMAKE_LFLAGS += -Wl,-z,origin \'-Wl,-rpath,$${IDE_PLUGIN_RPATH}\',--hash-style=sysv
  ...
  TARGET = lx_rrSceneParserMantra$${BIT_DEPTH}
  CONFIG(debug, debug|release) {
  ...
  QT       -= gui
	LIBS +=  -L../../../_libs
	OBJECTS_DIR = ../../../z_compiler_files/debug_lx$${BIT_DEPTH}_rrSceneParserMantra
  ...
  QT       -= gui
	...
	LIBS +=  -L../../../_libs
	OBJECTS_DIR = ../../../z_compiler_files/release_lx$${BIT_DEPTH}_rrSceneParserMantra
  ...
  TARGET = rrSceneParserMantra$${BIT_DEPTH}
  CONFIG(debug, debug|release) {
	DESTDIR = ../../../_debug/plugins/submitter_sceneparser
	LIBS +=  -L../../../_libs
	OBJECTS_DIR = ../../../z_compiler_files/debug_mac_rrSceneParserMantra
...
# Include file(s)
include(rrSceneParserMantra.pri)
