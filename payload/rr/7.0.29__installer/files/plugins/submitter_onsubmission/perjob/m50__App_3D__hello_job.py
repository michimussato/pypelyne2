...
rrGlobal.writeLog(rrGlobal.logLvL.info, "I am job " +job.sceneName,"Hello Job Script")
rrGlobal.progress_SetProgressA(2)

rrGlobal.messageBox(rrGlobal.logLvL.info, "I am job " +job.sceneName,"","", False,30)
