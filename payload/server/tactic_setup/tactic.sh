...
yum install -y nano wget unzip httpd ImageMagick postgresql postgresql-server postgresql-contrib postgresql-devel gcc zlib-devel libxslt-devel libxml2-devel python-devel
