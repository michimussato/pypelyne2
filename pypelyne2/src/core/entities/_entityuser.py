...
class EntityUser(entity.Entity):
    ...
    def __init__(self, d):
        ...
        # __dict__ has to be defined before inheriting from base
        # otherwise it overwrites the whole class content (self.__dict__)
        self.__dict__ = d

        super(EntityUser, self).__init__(entity_identifier=self.__dict__[u'identifier'])

        self.entity_type = 'user'
        # self.entity_type = type(self)
    ...
    def user_id(self):
        ...
        return self.__dict__[u'user_id']
