...
mac {
  DEFINES +=  rrConsoleApp rrPlugin defrrNotifyWinmessage
  QT += 
  QT       -= gui
  ...
  TARGET = mac_rrNotifyWinmessage
  CONFIG(debug, debug|release) {
	DESTDIR = ../../../../_debug/plugins/server_notify
	LIBS +=  -L../../../../_libs/osx -framework CoreFoundation -framework ApplicationServices -lz
	OBJECTS_DIR = ../../../../z_compiler_files/debug_mac_rrNotifyWinmessage
	MOC_DIR += ./GeneratedMac/debug
	INCLUDEPATH += ./GeneratedMac \
	    ./GeneratedMac/debug
	DEFINES += rrDEBUG
  } else {
	DESTDIR = ../../../../_release/plugins/server_notify
	LIBS +=  -L../../../../_libs/osx -framework CoreFoundation -framework ApplicationServices -lz
	OBJECTS_DIR = ../../../../z_compiler_files/release_mac_rrNotifyWinmessage
...
#	QMAKE_LFLAGS += -Wl,-z,origin \'-Wl,-rpath,$${IDE_PLUGIN_RPATH}\',--hash-style=sysv
  ...
  TARGET = lx_rrNotifyWinmessage$${BIT_DEPTH}
  CONFIG(debug, debug|release) {
	DESTDIR = ../../../_debug/plugins$${BIT_DEPTH}/server_notify
  DEFINES +=  rrConsoleApp rrPlugin defrrNotifyWinmessage
  QT += 
  QT       -= gui
	LIBS +=  -L../../../_libs
	OBJECTS_DIR = ../../../z_compiler_files/debug_lx$${BIT_DEPTH}_rrNotifyWinmessage
	MOC_DIR += ./GeneratedLx$${BIT_DEPTH}/debug
	INCLUDEPATH += ./GeneratedLx$${BIT_DEPTH} \
	    ./GeneratedLx$${BIT_DEPTH}/debug
	DEFINES += rrDEBUG
  } else {
	DESTDIR = ../../../_release/plugins$${BIT_DEPTH}/server_notify
  DEFINES +=  rrConsoleApp rrPlugin defrrNotifyWinmessage
  QT += 
  QT       -= gui
	...
	LIBS +=  -L../../../_libs
	OBJECTS_DIR = ../../../z_compiler_files/release_lx$${BIT_DEPTH}_rrNotifyWinmessage
  ...
  TARGET = rrNotifyWinmessage$${BIT_DEPTH}
  CONFIG(debug, debug|release) {
	DESTDIR = ../../../_debug/plugins/server_notify
	LIBS +=  -L../../../_libs
	OBJECTS_DIR = ../../../z_compiler_files/debug_mac_rrNotifyWinmessage
...
# Include file(s)
include(rrNotifyWinmessage.pri)
