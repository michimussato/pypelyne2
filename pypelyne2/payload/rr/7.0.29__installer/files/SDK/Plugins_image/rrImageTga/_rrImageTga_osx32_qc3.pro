...
#systems, pass the --hash-style=sysv option instead.
  ...
  TARGET = mac_rrImageTga

  CONFIG(debug, debug|release) {
	DESTDIR = ../../../../_debug/plugins/image
	LIBS +=  -L../../../../_libs/osx -L../../../../_release/bin/mac/lib -framework CoreFoundation -framework ApplicationServices -lz
	OBJECTS_DIR = ../../../../../z_compiler_files/debug_mac_rrImageTga
	MOC_DIR += ./GeneratedMac/debug
	INCLUDEPATH += ./GeneratedMac \
	    ./GeneratedMac/debug
	DEFINES += rrDEBUG
  } else {
	DESTDIR = ../../../../_release/plugins/image
	LIBS +=  -L../../../../_libs/osx -L../../../../_release/bin/mac/lib -framework CoreFoundation -framework ApplicationServices -lz
	OBJECTS_DIR = ../../../../../z_compiler_files/release_mac_rrImageTga
